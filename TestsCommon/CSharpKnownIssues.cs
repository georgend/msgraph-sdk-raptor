        ...
        return new Dictionary<string, KnownIssue>()
            {
                ...
                {$"get-rooms-in-roomlist-csharp-{version}-compiles", new KnownIssue(SDK, "SDK doesn't generate type segment in OData URL.", GitHubIssue: "https://github.com/microsoftgraph/MSGraph-SDK-Code-Generator/issues/239") },
                ...
                { "remove-rejectedsender-from-group-csharp-V1-compiles", new KnownIssue(SDK, DeleteAsyncIsNotSupportedForReferences, DeleteAsyncIsNotSupportedForReferencesGithubIssue) },
                { "delete-acceptedsenders-from-group-csharp-V1-compiles", new KnownIssue(SDK, DeleteAsyncIsNotSupportedForReferences, DeleteAsyncIsNotSupportedForReferencesGithubIssue) },
                { "put-b2xuserflows-apiconnectorconfiguration-postattributecollection-csharp-V1-compiles", new KnownIssue(SDK, ComplexTypeNavigationProperties, ComplexTypeNavigationPropertiesGithubIssue) },
                { "put-b2xuserflows-apiconnectorconfiguration-postfederationsignup-csharp-V1-compiles", new KnownIssue(SDK, ComplexTypeNavigationProperties, ComplexTypeNavigationPropertiesGithubIssue) },
                ...
                { "deploymentaudience-updateaudience-csharp-Beta-compiles", new KnownIssue(HTTP, GitHubIssue: "https://github.com/microsoftgraph/microsoft-graph-docs/issues/12811")},
                { "get-riskyuser-csharp-Beta-compiles", new KnownIssue(HTTP, GitHubIssue: "https://github.com/microsoftgraph/microsoft-graph-docs/issues/14876")},
                { "get-devicecompliancepolicysettingstatesummary-csharp-Beta-compiles", new KnownIssue(HTTP, GitHubIssue: "https://github.com/microsoftgraph/microsoft-graph-docs/issues/13596")},
                { "get-mailboxsettings-4-csharp-Beta-compiles", new KnownIssue(HTTP, GitHubIssue: "https://github.com/microsoftgraph/microsoft-graph-docs/issues/14238")},
                { "list-administrativeunit-csharp-V1-compiles", new KnownIssue(HTTP, GitHubIssue: "https://github.com/microsoftgraph/microsoft-graph-docs/issues/12770")},
                { "list-devicecompliancepolicysettingstatesummary-csharp-Beta-compiles", new KnownIssue(HTTP, GitHubIssue: "https://github.com/microsoftgraph/microsoft-graph-docs/issues/13597")},
                { "list-riskyuser-csharp-Beta-compiles", new KnownIssue(HTTP, GitHubIssue: "https://github.com/microsoftgraph/microsoft-graph-docs/issues/14875") },
                { "update-tenantcustomizedinformation-csharp-Beta-compiles", new KnownIssue(HTTP, GitHubIssue: "https://github.com/microsoftgraph/microsoft-graph-docs/issues/13556")},
                { "update-accessreviewscheduledefinition-csharp-Beta-compiles", new KnownIssue(HTTP, GitHubIssue: "https://github.com/microsoftgraph/microsoft-graph-docs/issues/14712")},
                { "update-appleidentityprovider-csharp-Beta-compiles", new KnownIssue(HTTP, GitHubIssue: "https://github.com/microsoftgraph/microsoft-graph-docs/issues/14713")},
                ...
                { $"create-schema-from-connection-async-csharp-{version}-compiles", new KnownIssue(SnippetGeneration, SnippetGenerationCreateAsyncSupport, SnippetGenerationCreateAsyncSupportGithubIssue) },
        ...
        return new Dictionary<string, KnownIssue>()
            {
                ...
                { "list-deployment-csharp-Beta-executes", MissingPermissionScopeKnownIssue },
                { "list-updatableassetgroup-csharp-Beta-executes", NeedsAnalysisKnownIssue },
                { "list-azureaddevice-csharp-Beta-executes", NeedsAnalysisKnownIssue },
                { "list-catalogentry-csharp-Beta-executes", NeedsAnalysisKnownIssue },
                ...
                { "list-permission-csharp-Beta-executes", MissingDataKnownIssue with { GitHubIssue = "https://github.com/microsoftgraph/msgraph-sdk-raptor/issues/571"} },
                { "get-educationlinkresource-from-educationassignment-csharp-Beta-executes", MissingDataKnownIssue with { GitHubIssue = "https://github.com/microsoftgraph/msgraph-sdk-raptor/issues/572"} },
                ...
                { "get-educationfileresource-from-educationassignment-csharp-Beta-executes", MissingDataKnownIssue with { GitHubIssue = "https://github.com/microsoftgraph/msgraph-sdk-raptor/issues/572"} },
                { "get-educationmediaresource-from-educationassignment-csharp-Beta-executes", MissingDataKnownIssue with { GitHubIssue = "https://github.com/microsoftgraph/msgraph-sdk-raptor/issues/572"} },
                { "get-educationpowerpointresource-from-educationassignment-csharp-Beta-executes", MissingDataKnownIssue with { GitHubIssue = "https://github.com/microsoftgraph/msgraph-sdk-raptor/issues/572"} },
                ...
                { "get-educationexcelresource-from-educationassignment-csharp-Beta-executes", NeedsAnalysisKnownIssue with{ GitHubIssue = "https://github.com/microsoftgraph/msgraph-sdk-raptor/issues/572" } },
                ...
                { "accessreviewinstance-filterbycurrentuser-csharp-V1-executes", MissingDataKnownIssue with { GitHubIssue = "https://github.com/microsoftgraph/msgraph-sdk-raptor/issues/608" } },
                { "accessreviewinstancedecisionitem-filterbycurrentuser-csharp-V1-executes", MissingDataKnownIssue with { GitHubIssue = "https://github.com/microsoftgraph/msgraph-sdk-raptor/issues/608" } },
                { "get-accessreviewinstance-csharp-V1-executes", MissingDataKnownIssue with { GitHubIssue = "https://github.com/microsoftgraph/msgraph-sdk-raptor/issues/608" } },
                { "get-accessreviewinstancedecisionitem-csharp-V1-executes", MissingDataKnownIssue with { GitHubIssue = "https://github.com/microsoftgraph/msgraph-sdk-raptor/issues/608" } },
                { "list-accessreviewinstance-csharp-V1-executes", MissingDataKnownIssue with { GitHubIssue = "https://github.com/microsoftgraph/msgraph-sdk-raptor/issues/608" } },
                { "list-accessreviewinstancedecisionitem-csharp-V1-executes", MissingDataKnownIssue with { GitHubIssue = "https://github.com/microsoftgraph/msgraph-sdk-raptor/issues/608" } },
                { "get-accessreviewscheduledefinition-csharp-V1-executes", MissingDataKnownIssue with { GitHubIssue = "https://github.com/microsoftgraph/msgraph-sdk-raptor/issues/608" } },

                { "educationschool-get-users-csharp-V1-executes", MissingDataKnownIssue with { GitHubIssue = "https://github.com/microsoftgraph/msgraph-sdk-raptor/issues/609" } },
                { "get-educationschool-csharp-V1-executes", MissingDataKnownIssue with { GitHubIssue = "https://github.com/microsoftgraph/msgraph-sdk-raptor/issues/609" } },
                { "get-classes-2-csharp-V1-executes", MissingDataKnownIssue with { GitHubIssue = "https://github.com/microsoftgraph/msgraph-sdk-raptor/issues/609" } },
                ...
                { "get-devices-by-extensionattribute-csharp-V1-executes", SDKMissingCountSupportKnownIssue },
