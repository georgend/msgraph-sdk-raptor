        ...
        return new Dictionary<string, KnownIssue>()
            {
                ...
                {$"get-phone-count-csharp-{version}-compiles", new KnownIssue(Category.SDKkiotaTriage, SearchHeaderIsNotSupported) },
                {$"get-pr-count-csharp-{version}-compiles", new KnownIssue(Category.SDKkiotaTriage, SearchHeaderIsNotSupported) },
                {$"get-team-count-csharp-{version}-compiles", new KnownIssue(Category.SDKkiotaTriage, SearchHeaderIsNotSupported) },
                {$"get-tier-count-csharp-{version}-compiles", new KnownIssue(Category.SDKkiotaTriage, SearchHeaderIsNotSupported) },
                {$"get-wa-count-csharp-{version}-compiles", new KnownIssue(Category.SDKkiotaTriage, SearchHeaderIsNotSupported) },
                {$"get-web-count-csharp-{version}-compiles", new KnownIssue(Category.SDKkiotaTriage, SearchHeaderIsNotSupported) },
                ...
                { "create-externaldomainname-from--csharp-Beta-compiles", new KnownIssue(Category.SDK, TypeCastIsNotSupported)},
                { "list-externaldomainname-csharp-Beta-compiles", new KnownIssue(Category.SDK, TypeCastIsNotSupported)},
                { "list-updatableasset-csharp-Beta-compiles", new KnownIssue(Category.SDK, TypeCastIsNotSupported)},
                { "reportroot-getm365appplatformusercounts-csv-csharp-Beta-compiles", new KnownIssue(Category.SDK, MissingContentProperty) },
                { "reportroot-getm365appplatformusercounts-json-csharp-Beta-compiles", new KnownIssue(Category.SDK, MissingContentProperty) },
                { "reportroot-getm365appusercoundetail-csharp-Beta-compiles", new KnownIssue(Category.SDK, MissingContentProperty) },
                { "reportroot-getm365appusercountdetail-csharp-Beta-compiles", new KnownIssue(Category.SDK, MissingContentProperty) },
                { "reportroot-getm365appusercounts-csv-csharp-Beta-compiles", new KnownIssue(Category.SDK, MissingContentProperty) },
                { "reportroot-getm365appusercounts-json-csharp-Beta-compiles", new KnownIssue(Category.SDK, MissingContentProperty) },
                { "get-transitivereports-user-csharp-Beta-compiles", CountIsNotSupportedKnownIssue},
                { "caseexportoperation-getdownloadurl-csharp-Beta-compiles", new KnownIssue(Category.SDK, TypeCastIsNotSupported) },
                ...
                { "list-riskyuser-csharp-Beta-compiles", new KnownIssue(Category.HTTP, GitHubIssue: "https://github.com/microsoftgraph/microsoft-graph-docs/issues/14875") },
